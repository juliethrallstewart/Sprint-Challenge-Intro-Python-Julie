...
# i = [n.name for n in humans if n.name.endswith("e")]
print(b)
# print(i)
...
c = [n.name for n in humans if n.name.startswith('C') or n.name.startswith('D') or n.name.startswith('E') or n.name.startswith('F') or n.name.startswith('G')]
print(c)
